...
<!-- Header Area Ends -->
                     ...
                     ?>
                        <div class="col-md-12">
							<div class="pn-post">
								...
								<p class="pn-athour-date"><strong><?php the_author(); ?></strong> <?php echo get_the_date(); ?></p>
								<p><?php the_content(); ?></p>
							</div>
						</div>
                       <?php
	...
	<div class="pn-footer-widget">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="pn-widget-left">
						<iframe src="https://www.youtube.com/embed/h924kiLlvA0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
				<div class="col-md-4">
					<div class="pn-widget-mid">
						<iframe src="https://www.youtube.com/embed/h924kiLlvA0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
				<div class="col-md-4">
